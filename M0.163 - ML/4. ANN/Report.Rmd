...
### 5.1 Matriz de confusión del modelo con 1 nodo
```{r}
library(neuralnet)
...
### 5.2 Matriz de confusión del modelo con 3 nodos
```{r}
require(neuralnet)
